...
from app.routers.api import app as combined
from app.routers.api import sam
from app.routers.api import placement as dumpster
from app.routers.api import newapi
...
api_v1_router.include_router(combined.router)
api_v1_router.include_router(sam.router)
api_v1_router.include_router(dumpster.router)
api_v1_router.include_router(newapi.router)
# api_v1_router.include_router(app.router)
